...
<main class="container">
    ...
    <article class="content">
        ...
        <p>Суммарно в этом году я набегал аж <strong>509 км</strong>, что также является абсолютным рекордом по общему расстоянию за год. Это на 86 км больше, чем в прошлом году.
            За последние 6,5 года я суммарно набегал уже <strong>1224 км</strong>.
        ...
        <img src="/images/blog/2024/run-2024/chart-4.png" alt="Максимальное расстояние (км) по годам">
        <br>
        <br>
        <div class="h3 text-center">Минимальное расстояние (км) по годам:</div>
        <img src="/images/blog/2024/run-2024/chart-5.png" alt="Минимальное расстояние (км) по годам">
        <br>
        <br>
        <div class="h3 text-center">Среднее расстояние (км) по годам:</div>
        <img src="/images/blog/2024/run-2024/chart-6.png" alt="Среднее расстояние (км) по годам">
        <br>
        <br>
        <div class="h3 text-center">Максимальное время (мин) по годам:</div>
        <img src="/images/blog/2024/run-2024/chart-7.png" alt="Максимальное время (мин) по годам">
        <br>
        <br>
        <div class="h3 text-center">Минимальное время (мин) по годам:</div>
        <img src="/images/blog/2024/run-2024/chart-8.png" alt="Минимальное время (мин) по годам">
        <br>
        <br>
        <div class="h3 text-center">Среднее время (мин) по годам:</div>
        <img src="/images/blog/2024/run-2024/chart-9.png" alt="Среднее время (мин) по годам">
